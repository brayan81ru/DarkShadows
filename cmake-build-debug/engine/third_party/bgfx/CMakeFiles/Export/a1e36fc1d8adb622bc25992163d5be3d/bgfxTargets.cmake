...
foreach(_cmake_expected_target IN ITEMS bgfx::bx bgfx::bin2c bgfx::bimg bgfx::bimg_decode bgfx::bimg_encode bgfx::texturec bgfx::bgfx bgfx::texturev bgfx::geometryc bgfx::geometryv bgfx::shaderc)
...
set_target_properties(bgfx::bx PROPERTIES
  ...
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include;${_IMPORT_PREFIX}/include/bx/compat/msvc"
...
set_target_properties(bgfx::bgfx PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "BX_CONFIG_DEBUG=\$<OR:\$<CONFIG:Debug>,\$<BOOL:OFF>>;BGFX_CONFIG_DEBUG_ANNOTATION=\$<AND:\$<NOT:\$<STREQUAL:Windows,WindowsStore>>,\$<OR:\$<CONFIG:Debug>,\$<BOOL:OFF>>>;BGFX_CONFIG_MULTITHREADED=\$<BOOL:ON>"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include;${_IMPORT_PREFIX}/include"
